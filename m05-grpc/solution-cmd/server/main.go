// Command server runs the profile-svc gRPC server. Run: go run ./solution-cmd/server
package main
...
import (
	...
	interceptor "cxm/m05/solution-interceptor"
	profile "cxm/m05/solution-profile"
)
